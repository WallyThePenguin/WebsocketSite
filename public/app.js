...
// Connect to the Socket.io server (automatically uses current host)
const socket = io();
...
function updateUsersList(users) {
    ...
    users.forEach(username => {
        ...
        li.innerHTML = `
            <div class="user-avatar" style="color: ${getUserColor(username)}; border-color: ${getUserColor(username)}33">
